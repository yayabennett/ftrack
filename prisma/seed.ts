...
async function main() {
    ...
    const exercises = [
        ...
        { name: 'Cable Crossovers', muscleGroup: MuscleGroup.CHEST, equipment: Equipment.CABLE },
        ...
        // TRICEPS (Push)
        { name: 'Trizepsdrücken (Kabelzug)', muscleGroup: MuscleGroup.TRICEPS, equipment: Equipment.CABLE },
        ...
        { name: 'Latzug (Enger Griff)', muscleGroup: MuscleGroup.BACK, equipment: Equipment.MACHINE },
        ...
        { name: 'Kabelrudern (Sitzend)', muscleGroup: MuscleGroup.BACK, equipment: Equipment.CABLE },
        { name: 'Rudermaschine (Brustgestützt)', muscleGroup: MuscleGroup.BACK, equipment: Equipment.MACHINE },
        { name: 'Pullover (Kabelzug)', muscleGroup: MuscleGroup.BACK, equipment: Equipment.CABLE },
        ...
        { name: 'Beinpresse / Leg Press', muscleGroup: MuscleGroup.QUADS, equipment: Equipment.MACHINE },
        { name: 'Bulgarian Split Squats', muscleGroup: MuscleGroup.QUADS, equipment: Equipment.DUMBBELL },
